## Занятие 6 Files, Drag and Drop

**Важно: в рамках этого нужно использовать пакетный менеджер yarn**
...
![](https://i.imgur.com/ysepmD8.png)

![](https://i.imgur.com/9sNBV9H.png)
...
![](https://i.imgur.com/NLA33km.png)

3. При наведении на другие позиции под карточку выделяется место по высоте равное размеру самой карточке, при это будет карточка ставится "до" или "после" элемента определяется исключетльно позицией курсора:

![](https://i.imgur.com/oEco5kq.png)
