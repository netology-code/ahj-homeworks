...
1. **Важно**: всё должно собираться через Webpack (включая картинки и стили) и выкладываться на Github Pages через CI.
...
**Важно: в рамках данного занятия в качестве пакетного менеджера необходимо использовать npm.**
