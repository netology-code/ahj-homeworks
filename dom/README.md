...
1. **Важно**: всё должно собираться через Webpack (включая картинки и стили) и выкладываться на Github Pages через GitHub Actions. [Инструкция](https://netospace.ru/drive/oo/r/126QYstmjfIyabA1ziW1U2NsVcsntbj3#tid=1&range=C6:C14)
