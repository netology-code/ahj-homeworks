...
1. В качестве результата присылайте ссылки на ваши GitHub-проект(ы)
...
Удостоверьтесь, что всё работает при прогоне тестов в GitHub Actions (не забудьте про headless-mode).
