...
Не забудьте поставить бейджики сборки.

Авто-тесты для данного ДЗ нужно сделать только на функцию, которая обрабатывает ввод пользователем координат вручную (см. задачу 1).
